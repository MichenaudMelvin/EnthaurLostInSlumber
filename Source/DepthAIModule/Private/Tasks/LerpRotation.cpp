...
#include "Tasks/LerpRotation.h"
#include "AIController.h"
#include "Kismet/KismetMathLibrary.h"

ULerpRotation::ULerpRotation()
{
	bNotifyTick = true;
}

EBTNodeResult::Type ULerpRotation::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void ULerpRotation::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
