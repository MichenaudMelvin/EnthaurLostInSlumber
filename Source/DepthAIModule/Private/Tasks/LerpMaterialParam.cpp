...
#include "Tasks/LerpMaterialParam.h"
#include "AIController.h"
#include "Kismet/KismetMaterialLibrary.h"
#include "Kismet/KismetMathLibrary.h"

ULerpMaterialParam::ULerpMaterialParam()
{
	bNotifyTick = true;
}

void ULerpMaterialParam::InitializeFromAsset(UBehaviorTree& Asset)
{
	Super::InitializeFromAsset(Asset);
}

EBTNodeResult::Type ULerpMaterialParam::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void ULerpMaterialParam::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
...
void ULerpMaterialParam::AddDynamicMaterial(UMeshComponent* MeshComponent, int32 InMaterialIndex)
{
