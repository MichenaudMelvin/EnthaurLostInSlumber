...
protected:
	...
	TSubclassOf<AENTDefaultCharacter> FirstPersonCharacterClass = AENTDefaultCharacter::StaticClass();

	UPROPERTY(EditDefaultsOnly, Category = "Debug")
	TSubclassOf<UENTCharacterFallState> CharacterFallStateClass = UENTCharacterFallState::StaticClass();
#endif
